...
/**
 * This is the item provider adapter for a {@link org.essembeh.rtfm.model.rtfm.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NodeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RtfmPackage.Literals.NODE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addFolderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_folder_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_folder_feature", "_UI_Node_type"),
				 RtfmPackage.Literals.NODE__FOLDER,
				 true,
				 false,
				 false,
	...
	protected void addRootPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_root_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_root_feature", "_UI_Node_type"),
				 RtfmPackage.Literals.NODE__ROOT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RtfmPackage.Literals.NODE__CONTENT);
			childrenFeatures.add(RtfmPackage.Literals.NODE__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RtfmPackage.Literals.NODE__CONTENT,
				 RtfmFactory.eINSTANCE.create(RtfmPackage.Literals.NODE_ENTRY)));

		newChildDescriptors.add
			(createChildParameter
				(RtfmPackage.Literals.NODE__ATTRIBUTES,
