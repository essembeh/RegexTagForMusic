...
/**
 * This is the item provider adapter for a {@link org.essembeh.rtfm.model.rtfm.Workflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkflowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RtfmPackage.Literals.WORKFLOW__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPatternPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_pattern_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_pattern_feature", "_UI_Workflow_type"),
				 RtfmPackage.Literals.WORKFLOW__PATTERN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFiltersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_filters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_filters_feature", "_UI_Workflow_type"),
				 RtfmPackage.Literals.WORKFLOW__FILTERS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RtfmPackage.Literals.WORKFLOW__TASKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RtfmPackage.Literals.WORKFLOW__TASKS,
				 RtfmFactory.eINSTANCE.createTask()));

		newChildDescriptors.add
			(createChildParameter
				(RtfmPackage.Literals.WORKFLOW__TASKS,
				 RtfmFactory.eINSTANCE.createExternalProcess()));

		newChildDescriptors.add
			(createChildParameter
				(RtfmPackage.Literals.WORKFLOW__TASKS,
				 RtfmFactory.eINSTANCE.createAttributeTool()));
	}
