...
public class OptionalField implements ITagField {
	 ...
	 * @param value
	 */
	public OptionalField(ITagField field) {
		this.field = field;
	}
	...
	public String getValue(String path) {
		String value = null;
		try {
			value = this.field.getValue(path);
		} catch (TagNotFoundException e) {
			logger.debug("Optional field: " + this.field + " did not match on path: " + path);
		}
		return value;
	}
	...
	public String toString() {
		return "OptionalField: " + this.field.toString();
	}
