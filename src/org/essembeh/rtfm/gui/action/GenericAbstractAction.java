...
public abstract class GenericAbstractAction extends AbstractAction {

	private static final long serialVersionUID = -4801896580741417417L;

	private static Logger logger = Logger.getLogger(GenericAbstractAction.class);

	GuiController controller;

	public GenericAbstractAction(GuiController controller) {
		this(controller, "", null);
	}

	public GenericAbstractAction(GuiController controller, String text, Image image) {
